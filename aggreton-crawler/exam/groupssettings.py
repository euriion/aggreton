...
__author__ = 'Shraddha Gupta <shraddhag@googleapps.com>'
...
# Console <http://code.googleapps.com/apis/console>
...
with information from the APIs Console <https://code.googleapps.com/apis/console>.
